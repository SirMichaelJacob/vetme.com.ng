                    ...
                    <div class="col-md-6">
                        ...
                        <form action="?" method="post">
                            <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="reemail" id="exampleInputEmail1" required placeholder="Enter email" />  
                                    <label for="exampleInputEmail1">New Password</label>                            
                                    <input type="password" class="form-control" name="password1" id="password1" onkeyup="check();" required placeholder="Password" />
                                    <label for="exampleInputEmail1">Re-type New Password</label>
                                    <input type="password" class="form-control" name="password2" id="password2" onkeyup="check();" required placeholder="Re-Password" />
                                    <span id='message'></span>
                                    <br/>
                                    <button type="submit" name="reset" value="reset" id="reset" class="btn btn-warning">Reset</button>
