...
<head>
   <meta charset="utf-8" />
    ...
    <title>VetMe - Staff Registration</title>
    <!-- BOOTSTRAP STYLES-->
...
<ul class="nav">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="checkbox">    
                              ...
                              <hr>
                              <button type="submit" name = "register" id="submit" value="admin" class="btn btn-default">Submit</button>
    ...
    <!-- /. WRAPPER  -->
    <footer >
        <?php include $_SERVER['DOCUMENT_ROOT'].'/vetme/footer.html.php';?>
    </footer>
    <!-- /. FOOTER  -->
